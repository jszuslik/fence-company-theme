<?php
/*
Template Name: Fence Landing page
*/
?>
<?php get_header(); ?>
...
<section id="fencepage">
  <div class="container">
    <div class="row">
      <?php $args = array(  //Set the arguments to the query, i.e. what posts are you looking for, how many, etc.
      'post_type' => 'fence-category',
      'order'   => 'ASC',
      'post_count' => -1 //Set to -1 for unlimited
          );

          $fence_category_loop = null;
          $fence_category_loop = new WP_Query($args);   //Create a new query, passing it the arguments you specified above

        while ( $fence_category_loop->have_posts() ) : $fence_category_loop->the_post();
          get_field('test_field'); ?>
            <div class="col-xs-12 col-sm-12 col-md-15 col-lg-15">
              <div class="panel panel-default">
                <div class="circular">
                  <a href="<?php the_field('link_to_post')?>"><img src="<?php the_field('main_image')?>" class="img-responsive" alt="" /></a>
                </div>
                <div class="panel-heading fence"><h3><a href="<?php the_field('link_to_post')?>"><?php the_title() ?></a></h3></div>
                <div class="panel-body">
                    <p><?php the_field('excerpt') ?></p>
                    <h4 class="pull-right btn-funnel fen"><a href="<?php the_field('link_to_post')?>">Read More <i class="fa fa-long-arrow-right"></i></a>
                  </div>
                </div>
              </div>
            <?php endwhile; ?>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
        <div class="featured featuredfence big">
